...
module.exports = [
	...
	{ path: "/find/jobs", 		method: "GET", 				config: Job.allJobs },
	{ path: "/job/{id*}", 		method: "GET", 				config: Job.viewJob },
	...
	{ path: "/job/accept", 		method: "POST", 			config: Job.acceptJob },
	{ path: "/job/current/{id*}", 	method: "GET", 			config: Job.currentJob },				
